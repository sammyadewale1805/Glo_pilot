...
const AccountPhoneNumberOPTScreen = () => {
  ...
  return (
    ...
    <View className='w-[95%] mt-6'>
      ...
      <View style={{marginTop: Responsiveness.getResponsiveWidth(1)}} className='flex flex-row items-center justify-center gap-7'>
...
export default AccountPhoneNumberOPTScreen