...
import PreviewCertificatePhoto from "../../../component/Account/PreviewCertificatePhoto";



const CerificateCamera = () => {
    ...
    useEffect(() => {
      ...
      if (photo) {
        return (<PreviewCertificatePhoto photo={photo} hasMediaLibraryPermission={hasMediaLibraryPermission} setPhoto={setPhoto}/>)
      }
...
export default CerificateCamera